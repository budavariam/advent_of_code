...
class MyTest(unittest.TestCase):
    ...
    def test_basic(self):
        """Test from the task"""
        self.assertEqual(solution("""Blueprint 1: Each ore robot costs 4 ore. Each clay robot costs 2 ore. Each obsidian robot costs 3 ore and 14 clay. Each geode robot costs 2 ore and 7 obsidian.
