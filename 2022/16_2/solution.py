...
class Code(object):
    ...
    def solve(self, minutes_left, start_valve):
        ...
        path_distances = step_floydwarshal(
            flowable_valves,
            steps,
            start_valve,
            minutes_left,
        ...
        total_flow = max(
            player_value + elephant_value
            for state_bitmap_player, player_value in path_distances.items()
            for state_bitmap_elephant, elephant_value in path_distances.items()
            if not state_bitmap_player & state_bitmap_elephant
        )
